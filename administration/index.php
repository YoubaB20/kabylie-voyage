...
<div class="row">
    ...
    <?php if (isset($_SESSION['flash'])) : ?>
        <?php foreach ($_SESSION['flash'] as $type => $message) : ?>
            <div class="col-12">
                <div class="alert alert-<?= $type; ?> alert-dismissible fade show" role="alert" id="alert-with-time">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="text-center mt-4 mb-4">
            <a href="sejours-administration.php" class="btn btn-outline-primary text-uppercase btn-afficher">afficher tout les séjours<i class="fas fa-angle-right ml-2"></i></a>
        </div>
    </div>
...
<div class="row">
    ...
    <!-- afficher tout les hôtels -->
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="text-center mt-4 mb-4">
            <a href="hotels-administration.php" class="btn btn-outline-primary text-uppercase btn-afficher">afficher tout les hôtels<i class="fas fa-angle-right ml-2"></i></a>
        </div>
    </div>
...
<div class="row mb-4">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="text-center mt-4 mb-4">
            <a href="vols-administration.php" class="btn btn-outline-primary text-uppercase btn-afficher">afficher tout les vols<i class="fas fa-angle-right ml-2"></i></a>
        </div>
    </div>
