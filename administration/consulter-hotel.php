...
<div class="row mt-3 mb-3 bg-light border p-2 m-2 details-offre">
    ...
    <div class="col-lg-6 col-md-12">
        ...
        <div class="action-buttons">
            <a href="modifier-hotel.php?id_hotel=<?= $hotel->id_hotel; ?>" class="btn btn-primary btn-sm mt-1 mr-2 modifier">Modifier</a>
            <a href="supprimer-hotel.php?id_hotel=<?= $hotel->id_hotel; ?>" class="btn btn-danger btn-sm mt-1 mr-2 confirmModalLink" data-toggle="modal" data-target="#ConfirmDeleteModal">Supprimer</a>
            <a href="update-image-hotel.php?id_hotel=<?= $hotel->id_hotel; ?>" class="btn btn-secondary btn-sm mt-1 changer-image">Modifier l'image</a>
        </div>
