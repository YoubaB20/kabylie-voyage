...
if (!isset($_SESSION['admin'])) {
    ...
    exit;
    // SI AUCUN ID VOL N'EST ENVOYÉ
} elseif (empty($_GET['id_vol'])) {
    $_SESSION['flash']['warning'] = "Vous devez sélectionner le vol que vous voulez modifier !";
...
if (isset($_POST['ModifVol'])) {
    ...
    if (!empty($_POST['ville_depart']) && !empty($_POST['ville_arrivee']) && !empty($_POST['date_depart']) && !empty($_POST['date_arrivee']) && !empty($_POST['heure_depart']) && !empty($_POST['heure_arrivee']) && !empty($_POST['companie_voyage']) && !empty($_POST['type_vol']) && !empty($_POST['aeroport_depart']) && !empty($_POST['aeroport_arrivee']) && !empty($_POST['classe_voyage']) && !empty($_POST['prix_vol'])) {
        ...
        if (!preg_match('/^[0-9]{4}-|\/[0-1][0-9]-|\/[0-3][0-9]$/', $date_depart)) {
            $errors[] = "Le format de la date de départ n'est pas valide !";
        }

        // ON VÉRIFIE LA VALIDITÉ DE LA DATE D'ARRIVÉE
        elseif (!preg_match('/^[0-9]{4}-|\/[0-1][0-9]-|\/[0-3][0-9]$/', $date_arrivee)) {
        ...
        elseif (!preg_match('/^[0-9 ]+$/', $prix_vol) && !filter_var($prix_vol, FILTER_VALIDATE_INT)) {
            $errors[] = "Le prix du vol doit étre des nombres seulement !";
        }

        // SI IL N'Y A AUCUNE ERREURE
        elseif (empty($errors)) {

            // ON FAIT UNE REQUETTE PRÉPARÉ A LA BDD POUR LA MISE AJOUR DES DONNEES 
            $req = $db->prepare(" UPDATE vols SET ville_depart =:ville_depart, ville_arrivee =:ville_arrivee, date_depart =:date_depart, date_arrivee =:date_arrivee, heure_depart =:heure_depart, heure_arrivee =:heure_arrivee, companie_voyage =:companie_voyage, type_vol =:type_vol, aeroport_depart =:aeroport_depart, aeroport_arrivee =:aeroport_arrivee, classe_voyage =:classe_voyage, prix_vol =:prix_vol WHERE id_vol = :id_vol ");
            $req->execute(
                [
                    ...
                    'companie_voyage' => $companie_voyage,
                    'type_vol' => $type_vol,
            ...
            $_SESSION['flash']['success'] = "Le vol a bien été modifié !";
...
<div class="row">
    <div class="col-12">
        <h4 class="text-uppercase">MODIFIER <?= $vol->ville_depart; ?><i class="fas fa-arrow-right mr-2 ml-2"></i><?= $vol->ville_arrivee; ?></h4>
    </div>
</div>
...
<div class="row mt-3 mb-3">
    <div class="col-12">
        <!-- formulaire de modification d'un vol -->
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ville_depart" name="ville_depart" value="<?= (isset($_POST['ville_depart']) ? $_POST['ville_depart'] : $vol->ville_depart); ?>" placeholder="Saisir la ville de départ" required>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ville_arrivee" name="ville_arrivee" value="<?= (isset($_POST['ville_arrivee']) ? $_POST['ville_arrivee'] : $vol->ville_arrivee); ?>" placeholder="Saisir la ville d'arrivée" required>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker" id="date_depart" name="date_depart" data-date-format="yyyy-mm-dd" value="<?= (isset($_POST['date_depart']) ? $_POST['date_depart'] : $vol->date_depart); ?>" placeholder="AAAA/MM/JJ" required>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker" id="date_arrivee" name="date_arrivee" data-date-format="yyyy-mm-dd" value="<?= (isset($_POST['date_arrivee']) ? $_POST['date_arrivee'] : $vol->date_arrivee); ?>" placeholder="AAAA/MM/JJ" required>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="time" class="form-control" id="heure_depart" name="heure_depart" value="<?= (isset($_POST['heure_depart']) ? $_POST['heure_depart'] : $vol->heure_depart); ?>" placeholder="Saisir l'heure de départ" required>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="time" class="form-control" id="heure_arrivee" name="heure_arrivee" value="<?= (isset($_POST['heure_arrivee']) ? $_POST['heure_arrivee'] : $vol->heure_arrivee); ?>" placeholder="Saisir l'heure d'arrivée" required>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <select id="companie_voyage" name="companie_voyage" class="form-control">
                            ...
                            <?php else : ?>
                                <option value="<?= $vol->companie_voyage; ?>" selected><?= $vol->companie_voyage; ?></option>
                            <?php endif; ?>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <select id="type_vol" name="type_vol" class="form-control">
                            ...
                            <?php else : ?>
                                <option value="<?= $vol->type_vol; ?>" selected><?= $vol->type_vol; ?></option>
                            <?php endif; ?>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <select id="aeroport_depart" name="aeroport_depart" class="form-control">
                            ...
                            <?php else : ?>
                                <option value="<?= $vol->aeroport_depart; ?>" selected><?= $vol->aeroport_depart; ?></option>
                            <?php endif; ?>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <select id="aeroport_arrivee" name="aeroport_arrivee" class="form-control">
                            ...
                            <!-- SI UN AEROPORT D'ARRIVÉE A ÉTAIT SELECTIONÉ ON L'AFFICHE DIRECTEMENT -->
                            <?php if (isset($_POST['aeroport_arrivee'])) : ?>
                                <option value="<?= $_POST['aeroport_arrivee']; ?>" selected><?= $_POST['aeroport_arrivee']; ?></option>
                            <?php else : ?>
                                <option value="<?= $vol->aeroport_arrivee; ?>" selected><?= $vol->aeroport_arrivee; ?></option>
                            <?php endif; ?>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <select id="classe_voyage" name="classe_voyage" class="form-control">
                            ...
                            <?php else : ?>
                                <option value="<?= $vol->classe_voyage; ?>" selected><?= $vol->classe_voyage; ?></option>
                            <?php endif; ?>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="prix_vol" name="prix_vol" value="<?= (isset($_POST['prix_vol']) ? $_POST['prix_vol'] : $vol->prix_vol); ?>" placeholder="Saisir le prix du vol" required>
                    </div>
                </div>

                <!--boutton du formulaire  -->
                <div class="col-12 mt-3">
                    <input type="submit" class="btn btn-primary" value="Valider" name="ModifVol">
                </div>

            </div>

        </form>
        <!--fin formulaire de modification d'un vol -->
