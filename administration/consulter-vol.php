    ...
    <div class="col-12 border-bottom pb-2">
        <div class="vol-consultation-header d-flex justify-content-between align-items-center">
            ...
            <div class="card-vol-voir">
                <!-- prix du vol -->
                <a href="#" class="btn btn-outline-primary btn-sm card-vol-prix mr-1 disabled" aria-disabled="true"><?= $vol->prix_vol; ?><span class="ml-1 text-uppercase">DZ</span></a>
                <a href="modifier-vol.php?id_vol=<?= $vol->id_vol; ?>" class="btn btn-primary btn-sm mr-1 modifier">Modifier</a>
                <a href="supprimer-vol.php?id_vol=<?= $vol->id_vol; ?>" class="btn btn-danger btn-sm mr-1 confirmModalLink" data-toggle="modal" data-target="#ConfirmDeleteModal">Supprimer</a>
            </div>
        </div>
    </div>
    <!--header consultation vol -->
